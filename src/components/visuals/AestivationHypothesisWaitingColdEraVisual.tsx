...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer HipÃ³tesis de la EstivaciÃ³n: Esperando la Era FrÃ­a del Universo desde Theories / Fermi.",
  ...
  "en": {
    ...
    "title": "HipÃ³tesis de la EstivaciÃ³n: Esperando la Era FrÃ­a del Universo",
    "description": "An animated visual for reading HipÃ³tesis de la EstivaciÃ³n: Esperando la Era FrÃ­a del Universo through Theories / Fermi.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function AestivationHypothesisWaitingColdEraVisual({ lang = "es" }: { lang?: Lang }) {
