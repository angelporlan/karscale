...
const copy = {
  "es": {
    ...
    "title": "ColisiÃ³n GalÃ¡ctica: El Destino de AndrÃ³meda y la VÃ­a LÃ¡ctea",
    "description": "Una visual animada para leer ColisiÃ³n GalÃ¡ctica: El Destino de AndrÃ³meda y la VÃ­a LÃ¡ctea desde Cosmos / Celestial Mechanics.",
    ...
    "metricAValue": "1.0x",
    "metricBValue": "Cosmos",
    "metricCValue": "Celestial Mechanics"
  },
  "en": {
    "eyebrow": "Cosmos archive",
    "title": "ColisiÃ³n GalÃ¡ctica: El Destino de AndrÃ³meda y la VÃ­a LÃ¡ctea",
    "description": "An animated visual for reading ColisiÃ³n GalÃ¡ctica: El Destino de AndrÃ³meda y la VÃ­a LÃ¡ctea through Cosmos / Celestial Mechanics.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function GalacticCollisionAndromedaMilkyWayVisual({ lang = "es" }: { lang?: Lang }) {
