...
const copy = {
  "es": {
    ...
    "title": "Decaimiento del VacÃ­o y la Burbuja de DestrucciÃ³n Verdadera",
    "description": "Una visual animada para leer Decaimiento del VacÃ­o y la Burbuja de DestrucciÃ³n Verdadera desde Cosmos / Universe Fate.",
    ...
    "metricAValue": "1.0x",
    "metricBValue": "Cosmos",
    "metricCValue": "Universe Fate"
  },
  "en": {
    "eyebrow": "Cosmos archive",
    "title": "Decaimiento del VacÃ­o y la Burbuja de DestrucciÃ³n Verdadera",
    "description": "An animated visual for reading Decaimiento del VacÃ­o y la Burbuja de DestrucciÃ³n Verdadera through Cosmos / Universe Fate.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function VacuumDecayTrueDestructionBubbleVisual({ lang = "es" }: { lang?: Lang }) {
