...
const copy = {
  "es": {
    ...
    "title": "La HipÃ³tesis de la SimulaciÃ³n: Â¿Es el Universo un CÃ³digo?",
    "description": "Una visual animada para leer La HipÃ³tesis de la SimulaciÃ³n: Â¿Es el Universo un CÃ³digo? desde Theories / Existential.",
  ...
  "en": {
    ...
    "title": "La HipÃ³tesis de la SimulaciÃ³n: Â¿Es el Universo un CÃ³digo?",
    "description": "An animated visual for reading La HipÃ³tesis de la SimulaciÃ³n: Â¿Es el Universo un CÃ³digo? through Theories / Existential.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function SimulationHypothesisUniverseCodeVisual({ lang = "es" }: { lang?: Lang }) {
