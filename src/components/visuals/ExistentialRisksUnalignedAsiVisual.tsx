...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Riesgos Existenciales de una ASI no alineada desde AI / ASI.",
  ...
  "en": {
    "eyebrow": "AI archive",
    "title": "Riesgos Existenciales de una ASI no alineada",
    "description": "An animated visual for reading Riesgos Existenciales de una ASI no alineada through AI / ASI.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function ExistentialRisksUnalignedAsiVisual({ lang = "es" }: { lang?: Lang }) {
