...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer CriptografÃ­a Post-CuÃ¡ntica y Seguridad de Datos Futura desde Tech / Quantum.",
  ...
  "en": {
    ...
    "title": "CriptografÃ­a Post-CuÃ¡ntica y Seguridad de Datos Futura",
    "description": "An animated visual for reading CriptografÃ­a Post-CuÃ¡ntica y Seguridad de Datos Futura through Tech / Quantum.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function PostQuantumCryptographySecurityVisual({ lang = "es" }: { lang?: Lang }) {
