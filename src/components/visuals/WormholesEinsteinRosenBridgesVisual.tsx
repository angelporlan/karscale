...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Agujeros de Gusano: Puentes de Einstein-Rosen IntergalÃ¡cticos desde Theories / Fringe Physics.",
    ...
    "metricCValue": "Fringe Physics"
  },
  "en": {
    "eyebrow": "Theories archive",
    "title": "Agujeros de Gusano: Puentes de Einstein-Rosen IntergalÃ¡cticos",
    "description": "An animated visual for reading Agujeros de Gusano: Puentes de Einstein-Rosen IntergalÃ¡cticos through Theories / Fringe Physics.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function WormholesEinsteinRosenBridgesVisual({ lang = "es" }: { lang?: Lang }) {
