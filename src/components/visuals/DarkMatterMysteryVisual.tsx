...
const copy = {
  "es": {
    ...
    "title": "El Misterio Insondable de la Materia Oscura",
    "description": "Una visual animada para leer El Misterio Insondable de la Materia Oscura desde Cosmos / Celestial Mechanics.",
  ...
  "en": {
    ...
    "title": "El Misterio Insondable de la Materia Oscura",
    "description": "An animated visual for reading El Misterio Insondable de la Materia Oscura through Cosmos / Celestial Mechanics.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function DarkMatterMysteryVisual({ lang = "es" }: { lang?: Lang }) {
