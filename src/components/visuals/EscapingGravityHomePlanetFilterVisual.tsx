...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Escapar de la Gravedad: El Planeta de Origen como Filtro CrÃ­tico desde Theories / Great Filter.",
  ...
  "en": {
    ...
    "title": "Escapar de la Gravedad: El Planeta de Origen como Filtro CrÃ­tico",
    "description": "An animated visual for reading Escapar de la Gravedad: El Planeta de Origen como Filtro CrÃ­tico through Theories / Great Filter.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function EscapingGravityHomePlanetFilterVisual({ lang = "es" }: { lang?: Lang }) {
