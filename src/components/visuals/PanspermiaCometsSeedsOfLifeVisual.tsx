...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Panspermia: ¿Son los Cometas Semillas de Vida? desde Cosmos / Xenobiology.",
  ...
  "en": {
    ...
    "title": "Panspermia: ¿Son los Cometas Semillas de Vida?",
    "description": "An animated visual for reading Panspermia: ¿Son los Cometas Semillas de Vida? through Cosmos / Xenobiology.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function PanspermiaCometsSeedsOfLifeVisual({ lang = "es" }: { lang?: Lang }) {
