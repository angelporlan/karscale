...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Solipsismo CÃ³smico y la Naturaleza Subjetiva de la Realidad desde Theories / Existential.",
    ...
    "metricCValue": "Existential"
  },
  "en": {
    "eyebrow": "Theories archive",
    "title": "Solipsismo CÃ³smico y la Naturaleza Subjetiva de la Realidad",
    "description": "An animated visual for reading Solipsismo CÃ³smico y la Naturaleza Subjetiva de la Realidad through Theories / Existential.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function CosmicSolipsismSubjectiveRealityVisual({ lang = "es" }: { lang?: Lang }) {
