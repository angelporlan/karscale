...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Supertierras vs Minineptunos: La Línea Divisoria desde Cosmos / Exoplanets.",
  ...
  "en": {
    ...
    "title": "Supertierras vs Minineptunos: La Línea Divisoria",
    "description": "An animated visual for reading Supertierras vs Minineptunos: La Línea Divisoria through Cosmos / Exoplanets.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function SupertierrasVsMinineptunosVisual({ lang = "es" }: { lang?: Lang }) {
