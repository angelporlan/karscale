...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer El Impacto de los Superconductores a Temperatura Ambiente desde Tech / Materials.",
  ...
  "en": {
    ...
    "title": "El Impacto de los Superconductores a Temperatura Ambiente",
    "description": "An animated visual for reading El Impacto de los Superconductores a Temperatura Ambiente through Tech / Materials.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function RoomTemperatureSuperconductorsImpactVisual({ lang = "es" }: { lang?: Lang }) {
