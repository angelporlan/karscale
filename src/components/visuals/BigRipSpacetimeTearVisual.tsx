...
const copy = {
  "es": {
    ...
    "title": "Big Rip: El Desgarro Final del Espaciotiempo",
    "description": "Una visual animada para leer Big Rip: El Desgarro Final del Espaciotiempo desde Cosmos / Universe Fate.",
  ...
  "en": {
    ...
    "title": "Big Rip: El Desgarro Final del Espaciotiempo",
    "description": "An animated visual for reading Big Rip: El Desgarro Final del Espaciotiempo through Cosmos / Universe Fate.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function BigRipSpacetimeTearVisual({ lang = "es" }: { lang?: Lang }) {
