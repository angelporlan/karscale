...
const copy = {
  "es": {
    ...
    "title": "Motores Warp: Doblando la M̩trica de Alcubierre",
    "description": "Una visual animada para leer Motores Warp: Doblando la M̩trica de Alcubierre desde Theories / Fringe Physics.",
  ...
  "en": {
    ...
    "title": "Motores Warp: Doblando la M̩trica de Alcubierre",
    "description": "An animated visual for reading Motores Warp: Doblando la M̩trica de Alcubierre through Theories / Fringe Physics.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function WarpDrivesAlcubierreMetricVisual({ lang = "es" }: { lang?: Lang }) {
