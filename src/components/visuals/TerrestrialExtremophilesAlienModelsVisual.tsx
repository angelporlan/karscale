...
const copy = {
  "es": {
    ...
    "title": "ExtremÃ³filos Terrestres como Modelos AlienÃ­genas",
    "description": "Una visual animada para leer ExtremÃ³filos Terrestres como Modelos AlienÃ­genas desde Cosmos / Xenobiology.",
  ...
  "en": {
    ...
    "title": "ExtremÃ³filos Terrestres como Modelos AlienÃ­genas",
    "description": "An animated visual for reading ExtremÃ³filos Terrestres como Modelos AlienÃ­genas through Cosmos / Xenobiology.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function TerrestrialExtremophilesAlienModelsVisual({ lang = "es" }: { lang?: Lang }) {
