...
const copy = {
  "es": {
    "eyebrow": "Archivo AI",
    "title": "Impacto EconÃ³mico Inmediato de la Inteligencia General",
    "description": "Una visual animada para leer Impacto EconÃ³mico Inmediato de la Inteligencia General desde AI / AGI.",
  ...
  "en": {
    "eyebrow": "AI archive",
    "title": "Impacto EconÃ³mico Inmediato de la Inteligencia General",
    "description": "An animated visual for reading Impacto EconÃ³mico Inmediato de la Inteligencia General through AI / AGI.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function EconomicImpactGeneralIntelligenceVisual({ lang = "es" }: { lang?: Lang }) {
