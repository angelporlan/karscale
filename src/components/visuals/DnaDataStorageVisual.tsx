...
const copy = {
  "es": {
    "eyebrow": "Archivo AI",
    "title": "Almacenamiento de Datos Masivos en Cadenas de ADN",
    "description": "Una visual animada para leer Almacenamiento de Datos Masivos en Cadenas de ADN desde AI / Biocomputing.",
  ...
  "en": {
    "eyebrow": "AI archive",
    "title": "Almacenamiento de Datos Masivos en Cadenas de ADN",
    "description": "An animated visual for reading Almacenamiento de Datos Masivos en Cadenas de ADN through AI / Biocomputing.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function DnaDataStorageVisual({ lang = "es" }: { lang?: Lang }) {
