...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer TerraformaciÃ³n de Marte: Fase Inicial e IngenierÃ­a AtmosfÃ©rica desde Kardashev / Multiplanetary.",
    ...
    "metricCValue": "Multiplanetary"
  },
  "en": {
    "eyebrow": "Kardashev archive",
    "title": "TerraformaciÃ³n de Marte: Fase Inicial e IngenierÃ­a AtmosfÃ©rica",
    "description": "An animated visual for reading TerraformaciÃ³n de Marte: Fase Inicial e IngenierÃ­a AtmosfÃ©rica through Kardashev / Multiplanetary.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function MarsTerraformingInitialPhaseVisual({ lang = "es" }: { lang?: Lang }) {
