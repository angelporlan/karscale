...
const copy = {
  "es": {
    "eyebrow": "Archivo Tech",
    "title": "Metamateriales: Invisibilidad y ManipulaciÃ³n Ã“ptica Avanzada",
    "description": "Una visual animada para leer Metamateriales: Invisibilidad y ManipulaciÃ³n Ã“ptica Avanzada desde Tech / Materials.",
    ...
    "metricAValue": "1.0x",
    "metricBValue": "Tech",
    "metricCValue": "Materials"
  },
  "en": {
    "eyebrow": "Tech archive",
    "title": "Metamateriales: Invisibilidad y ManipulaciÃ³n Ã“ptica Avanzada",
    "description": "An animated visual for reading Metamateriales: Invisibilidad y ManipulaciÃ³n Ã“ptica Avanzada through Tech / Materials.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function MetamaterialsOpticalInvisibilityVisual({ lang = "es" }: { lang?: Lang }) {
