...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Interfaces HÃ­bridas: CÃ©lulas Vivas en Placas de Circuito desde AI / Biocomputing.",
    ...
    "metricAValue": "1.0x",
    "metricBValue": "AI",
    "metricCValue": "Biocomputing"
  },
  "en": {
    "eyebrow": "AI archive",
    "title": "Interfaces HÃ­bridas: CÃ©lulas Vivas en Placas de Circuito",
    "description": "An animated visual for reading Interfaces HÃ­bridas: CÃ©lulas Vivas en Placas de Circuito through AI / Biocomputing.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function HybridInterfacesCellsCircuitsVisual({ lang = "es" }: { lang?: Lang }) {
