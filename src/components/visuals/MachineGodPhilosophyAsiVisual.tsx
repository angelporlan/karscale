...
const copy = {
  "es": {
    "eyebrow": "Archivo AI",
    "title": "Dios MÃ¡quina: Perspectivas FilosÃ³ficas de la ASI",
    "description": "Una visual animada para leer Dios MÃ¡quina: Perspectivas FilosÃ³ficas de la ASI desde AI / ASI.",
  ...
  "en": {
    "eyebrow": "AI archive",
    "title": "Dios MÃ¡quina: Perspectivas FilosÃ³ficas de la ASI",
    "description": "An animated visual for reading Dios MÃ¡quina: Perspectivas FilosÃ³ficas de la ASI through AI / ASI.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function MachineGodPhilosophyAsiVisual({ lang = "es" }: { lang?: Lang }) {
