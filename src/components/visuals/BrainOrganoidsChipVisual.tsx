...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Cerebros en un Chip: Organoides Cerebrales Interactivos desde AI / Biocomputing.",
  ...
  "en": {
    "eyebrow": "AI archive",
    "title": "Cerebros en un Chip: Organoides Cerebrales Interactivos",
    "description": "An animated visual for reading Cerebros en un Chip: Organoides Cerebrales Interactivos through AI / Biocomputing.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function BrainOrganoidsChipVisual({ lang = "es" }: { lang?: Lang }) {
