...
const copy = {
  "es": {
    ...
    "title": "Planetas Errantes (Rogue Planets) en la Oscuridad CÃ³smica",
    "description": "Una visual animada para leer Planetas Errantes (Rogue Planets) en la Oscuridad CÃ³smica desde Cosmos / Exoplanets.",
  ...
  "en": {
    ...
    "title": "Planetas Errantes (Rogue Planets) en la Oscuridad CÃ³smica",
    "description": "An animated visual for reading Planetas Errantes (Rogue Planets) en la Oscuridad CÃ³smica through Cosmos / Exoplanets.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function RoguePlanetsCosmicDarknessVisual({ lang = "es" }: { lang?: Lang }) {
