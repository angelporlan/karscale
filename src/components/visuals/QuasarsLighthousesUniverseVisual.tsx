...
const copy = {
  "es": {
    ...
    "title": "CuÃ¡sares: Los Faros mÃ¡s Brillantes del Universo",
    "description": "Una visual animada para leer CuÃ¡sares: Los Faros mÃ¡s Brillantes del Universo desde Cosmos / Celestial Mechanics.",
  ...
  "en": {
    ...
    "title": "CuÃ¡sares: Los Faros mÃ¡s Brillantes del Universo",
    "description": "An animated visual for reading CuÃ¡sares: Los Faros mÃ¡s Brillantes del Universo through Cosmos / Celestial Mechanics.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function QuasarsLighthousesUniverseVisual({ lang = "es" }: { lang?: Lang }) {
