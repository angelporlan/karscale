...
const copy = {
  "es": {
    ...
    "title": "Estrellas Artificiales y Reciclaje de Galaxias Muertas",
    "description": "Una visual animada para leer Estrellas Artificiales y Reciclaje de Galaxias Muertas desde Kardashev / Type 3.",
  ...
  "en": {
    ...
    "title": "Estrellas Artificiales y Reciclaje de Galaxias Muertas",
    "description": "An animated visual for reading Estrellas Artificiales y Reciclaje de Galaxias Muertas through Kardashev / Type 3.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function ArtificialStarsGalaxyRecyclingVisual({ lang = "es" }: { lang?: Lang }) {
