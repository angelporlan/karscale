...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer AnatomÃ­a de un Agujero Negro Supermasivo desde Cosmos / Celestial Mechanics.",
  ...
  "en": {
    ...
    "title": "AnatomÃ­a de un Agujero Negro Supermasivo",
    "description": "An animated visual for reading AnatomÃ­a de un Agujero Negro Supermasivo through Cosmos / Celestial Mechanics.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function SupermassiveBlackHoleAnatomyVisual({ lang = "es" }: { lang?: Lang }) {
