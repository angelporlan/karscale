...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Control de Infraestructuras CrÃ­ticas por una ASI desde AI / ASI.",
  ...
  "en": {
    "eyebrow": "AI archive",
    "title": "Control de Infraestructuras CrÃ­ticas por una ASI",
    "description": "An animated visual for reading Control de Infraestructuras CrÃ­ticas por una ASI through AI / ASI.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function CriticalInfrastructureControlAsiVisual({ lang = "es" }: { lang?: Lang }) {
