...
const copy = {
  "es": {
    ...
    "title": "Qubits TopolÃ³gicos y la Lucha por la CorrecciÃ³n de Errores",
    "description": "Una visual animada para leer Qubits TopolÃ³gicos y la Lucha por la CorrecciÃ³n de Errores desde Tech / Quantum.",
    ...
    "metricAValue": "1.0x",
    "metricBValue": "Tech",
    "metricCValue": "Quantum"
  },
  "en": {
    "eyebrow": "Tech archive",
    "title": "Qubits TopolÃ³gicos y la Lucha por la CorrecciÃ³n de Errores",
    "description": "An animated visual for reading Qubits TopolÃ³gicos y la Lucha por la CorrecciÃ³n de Errores through Tech / Quantum.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function TopologicalQubitsErrorCorrectionVisual({ lang = "es" }: { lang?: Lang }) {
