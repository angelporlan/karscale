...
const copy = {
  "es": {
    ...
    "title": "Biosferas de Enanas Rojas y el Problema del Bloqueo Mareal",
    "description": "Una visual animada para leer Biosferas de Enanas Rojas y el Problema del Bloqueo Mareal desde Cosmos / Xenobiology.",
  ...
  "en": {
    ...
    "title": "Biosferas de Enanas Rojas y el Problema del Bloqueo Mareal",
    "description": "An animated visual for reading Biosferas de Enanas Rojas y el Problema del Bloqueo Mareal through Cosmos / Xenobiology.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function RedDwarfBiospheresTidalLockingVisual({ lang = "es" }: { lang?: Lang }) {
