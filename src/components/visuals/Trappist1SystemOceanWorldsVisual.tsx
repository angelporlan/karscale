...
const copy = {
  "es": {
    ...
    "title": "El Sistema TRAPPIST-1 y sus Mundos OceÃ¡nicos TeÃ³ricos",
    "description": "Una visual animada para leer El Sistema TRAPPIST-1 y sus Mundos OceÃ¡nicos TeÃ³ricos desde Cosmos / Exoplanets.",
  ...
  "en": {
    ...
    "title": "El Sistema TRAPPIST-1 y sus Mundos OceÃ¡nicos TeÃ³ricos",
    "description": "An animated visual for reading El Sistema TRAPPIST-1 y sus Mundos OceÃ¡nicos TeÃ³ricos through Cosmos / Exoplanets.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function Trappist1SystemOceanWorldsVisual({ lang = "es" }: { lang?: Lang }) {
