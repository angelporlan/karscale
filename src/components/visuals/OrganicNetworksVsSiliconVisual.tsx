...
const copy = {
  "es": {
    "eyebrow": "Archivo AI",
    "title": "Redes Neuronales OrgÃ¡nicas vs Redes de Silicio",
    "description": "Una visual animada para leer Redes Neuronales OrgÃ¡nicas vs Redes de Silicio desde AI / Biocomputing.",
  ...
  "en": {
    "eyebrow": "AI archive",
    "title": "Redes Neuronales OrgÃ¡nicas vs Redes de Silicio",
    "description": "An animated visual for reading Redes Neuronales OrgÃ¡nicas vs Redes de Silicio through AI / Biocomputing.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function OrganicNetworksVsSiliconVisual({ lang = "es" }: { lang?: Lang }) {
