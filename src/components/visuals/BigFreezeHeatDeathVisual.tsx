...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Big Freeze: La Muerte T̩rmica del Universo desde Cosmos / Universe Fate.",
  ...
  "en": {
    ...
    "title": "Big Freeze: La Muerte T̩rmica del Universo",
    "description": "An animated visual for reading Big Freeze: La Muerte T̩rmica del Universo through Cosmos / Universe Fate.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function BigFreezeHeatDeathVisual({ lang = "es" }: { lang?: Lang }) {
