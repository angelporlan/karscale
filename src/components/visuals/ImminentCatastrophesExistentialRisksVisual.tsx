...
const copy = {
  "es": {
    "eyebrow": "Archivo Theories",
    "title": "CatÃ¡strofes Inminentes: IA, Bioterrorismo y Riesgos Existenciales",
    "description": "Una visual animada para leer CatÃ¡strofes Inminentes: IA, Bioterrorismo y Riesgos Existenciales desde Theories / Great Filter.",
    "badge": "Escaneo activo",
    "metricA": "Señal",
    "metricB": "Escala",
    "metricC": "Horizonte",
    "metricAValue": "1.0x",
    "metricBValue": "Theories",
    "metricCValue": "Great Filter"
  },
  "en": {
    "eyebrow": "Theories archive",
    "title": "CatÃ¡strofes Inminentes: IA, Bioterrorismo y Riesgos Existenciales",
    "description": "An animated visual for reading CatÃ¡strofes Inminentes: IA, Bioterrorismo y Riesgos Existenciales through Theories / Great Filter.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function ImminentCatastrophesExistentialRisksVisual({ lang = "es" }: { lang?: Lang }) {
