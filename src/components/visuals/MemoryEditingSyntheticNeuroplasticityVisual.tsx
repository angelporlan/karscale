...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer EdiciÃ³n de Memorias y Neuroplasticidad SintÃ©tica desde Tech / Neurotech.",
  ...
  "en": {
    ...
    "title": "EdiciÃ³n de Memorias y Neuroplasticidad SintÃ©tica",
    "description": "An animated visual for reading EdiciÃ³n de Memorias y Neuroplasticidad SintÃ©tica through Tech / Neurotech.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function MemoryEditingSyntheticNeuroplasticityVisual({ lang = "es" }: { lang?: Lang }) {
