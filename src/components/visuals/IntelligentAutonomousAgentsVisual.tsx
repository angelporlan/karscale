...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer El papel de los Agentes AutÃ³nomos Inteligentes desde AI / Current AI.",
    ...
    "metricAValue": "1.0x",
    "metricBValue": "AI",
    "metricCValue": "Current AI"
  },
  "en": {
    "eyebrow": "AI archive",
    "title": "El papel de los Agentes AutÃ³nomos Inteligentes",
    "description": "An animated visual for reading El papel de los Agentes AutÃ³nomos Inteligentes through AI / Current AI.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function IntelligentAutonomousAgentsVisual({ lang = "es" }: { lang?: Lang }) {
