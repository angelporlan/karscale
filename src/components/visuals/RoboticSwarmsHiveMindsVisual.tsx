...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Enjambres RobÃ³ticos y Algoritmos de Mentes Colmena desde Tech / Robotics.",
  ...
  "en": {
    ...
    "title": "Enjambres RobÃ³ticos y Algoritmos de Mentes Colmena",
    "description": "An animated visual for reading Enjambres RobÃ³ticos y Algoritmos de Mentes Colmena through Tech / Robotics.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function RoboticSwarmsHiveMindsVisual({ lang = "es" }: { lang?: Lang }) {
