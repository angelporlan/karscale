...
const copy = {
  "es": {
    ...
    "title": "La TeorÃ­a de Cuerdas y las Dimensiones Ocultas",
    "description": "Una visual animada para leer La TeorÃ­a de Cuerdas y las Dimensiones Ocultas desde Theories / Fringe Physics.",
  ...
  "en": {
    ...
    "title": "La TeorÃ­a de Cuerdas y las Dimensiones Ocultas",
    "description": "An animated visual for reading La TeorÃ­a de Cuerdas y las Dimensiones Ocultas through Theories / Fringe Physics.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function StringTheoryHiddenDimensionsVisual({ lang = "es" }: { lang?: Lang }) {
