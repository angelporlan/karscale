...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Escalamiento de ParÃ¡metros: Â¿Hemos tocado techo? desde AI / Current AI.",
  ...
  "en": {
    "eyebrow": "AI archive",
    "title": "Escalamiento de ParÃ¡metros: Â¿Hemos tocado techo?",
    "description": "An animated visual for reading Escalamiento de ParÃ¡metros: Â¿Hemos tocado techo? through AI / Current AI.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function ParameterScalingCeilingVisual({ lang = "es" }: { lang?: Lang }) {
