...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Enjambres de Dyson: La alternativa modular a la Esfera desde Kardashev / Type 2.",
  ...
  "en": {
    ...
    "title": "Enjambres de Dyson: La alternativa modular a la Esfera",
    "description": "An animated visual for reading Enjambres de Dyson: La alternativa modular a la Esfera through Kardashev / Type 2.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function DysonSwarmsModularAlternativeVisual({ lang = "es" }: { lang?: Lang }) {
