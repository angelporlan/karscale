...
const copy = {
  "es": {
    ...
    "title": "La AutomatizaciÃ³n Industrial 100% AutÃ³noma e Ininterrumpida",
    "description": "Una visual animada para leer La AutomatizaciÃ³n Industrial 100% AutÃ³noma e Ininterrumpida desde Tech / Robotics.",
    ...
    "metricAValue": "1.0x",
    "metricBValue": "Tech",
    "metricCValue": "Robotics"
  },
  "en": {
    "eyebrow": "Tech archive",
    "title": "La AutomatizaciÃ³n Industrial 100% AutÃ³noma e Ininterrumpida",
    "description": "An animated visual for reading La AutomatizaciÃ³n Industrial 100% AutÃ³noma e Ininterrumpida through Tech / Robotics.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function AutonomousIndustrialAutomationVisual({ lang = "es" }: { lang?: Lang }) {
