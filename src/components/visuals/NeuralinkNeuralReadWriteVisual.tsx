...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Neuralink y el Salto hacia la Lectura y Escritura Neuronal desde Tech / Neurotech.",
    ...
    "metricAValue": "1.0x",
    "metricBValue": "Tech",
    "metricCValue": "Neurotech"
  },
  "en": {
    "eyebrow": "Tech archive",
    "title": "Neuralink y el Salto hacia la Lectura y Escritura Neuronal",
    "description": "An animated visual for reading Neuralink y el Salto hacia la Lectura y Escritura Neuronal through Tech / Neurotech.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function NeuralinkNeuralReadWriteVisual({ lang = "es" }: { lang?: Lang }) {
