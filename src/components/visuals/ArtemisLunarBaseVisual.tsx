...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer Base Lunar Artemis: Plataforma de Salto al Cosmos desde Kardashev / Multiplanetary.",
  ...
  "en": {
    ...
    "title": "Base Lunar Artemis: Plataforma de Salto al Cosmos",
    "description": "An animated visual for reading Base Lunar Artemis: Plataforma de Salto al Cosmos through Kardashev / Multiplanetary.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function ArtemisLunarBaseVisual({ lang = "es" }: { lang?: Lang }) {
