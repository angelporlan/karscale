...
const copy = {
  "es": {
    ...
    "description": "Una visual animada para leer La AGI como Herramienta de InvestigaciÃ³n CientÃ­fica desde AI / AGI.",
  ...
  "en": {
    "eyebrow": "AI archive",
    "title": "La AGI como Herramienta de InvestigaciÃ³n CientÃ­fica",
    "description": "An animated visual for reading La AGI como Herramienta de InvestigaciÃ³n CientÃ­fica through AI / AGI.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function AgiScientificResearchToolVisual({ lang = "es" }: { lang?: Lang }) {
