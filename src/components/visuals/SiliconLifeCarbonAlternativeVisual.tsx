...
const copy = {
  "es": {
    ...
    "title": "Vida basada en Silicio: Alternativas BioquÃ­micas al Carbono",
    "description": "Una visual animada para leer Vida basada en Silicio: Alternativas BioquÃ­micas al Carbono desde Cosmos / Xenobiology.",
    ...
    "metricAValue": "1.0x",
    "metricBValue": "Cosmos",
    "metricCValue": "Xenobiology"
  },
  "en": {
    "eyebrow": "Cosmos archive",
    "title": "Vida basada en Silicio: Alternativas BioquÃ­micas al Carbono",
    "description": "An animated visual for reading Vida basada en Silicio: Alternativas BioquÃ­micas al Carbono through Cosmos / Xenobiology.",
    "badge": "Active scan",
    "metricA": "Signal",
    "metricB": "Scale",
    "metricC": "Horizon",
...
export default function SiliconLifeCarbonAlternativeVisual({ lang = "es" }: { lang?: Lang }) {
